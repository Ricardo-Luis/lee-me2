...
ThreeColumn(md"`RLcircuit.jl`", md"[![](https://img.shields.io/badge/GitHub_URL-notebook-C09107)](https://github.com/Ricardo-Luis/notebooks/blob/main/ME2/RLcircuit.jl)", md"`Last update: 27·11·2023`")
...
md"""
A biblioteca `Julia`, [`Plots.jl`](http://docs.juliaplots.org/latest/), que tem sido utilizada nos diversos *notebooks* para realização de gráficos, reconhece nativamente números complexos, representando-os num plano de Argand, também conhecido como plano complexo.
...
# ╔═╡ dc85c7f4-17c6-4fb8-8802-16ddc72cb56d


# ╔═╡ 359f907e-66b3-4505-9504-811989c6c09f
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "cda4f87d7118795e38f60f90a5a2ebdd6a5ad6ba"
